...
def D_lambda(img_lm,img_fake, block_size=32, p=1):
    """Spectral distortion
...
def D_s(img_lm, pan,img_fake, satellite='QuickBird', scale=4, block_size=32, q=1):
    """Spatial distortion
    img_fake, generated HRMS
    img_lm, LRMS
    pan, HRPan"""
...
def qnr(img_lm, pan, img_fake,satellite='QuickBird', scale=4, block_size=32, p=1, q=1, alpha=1, beta=1):
