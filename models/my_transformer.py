...
class my_model_3_7(nn.Module):#其实差不多 跟unet
    ...
    def forward(self, x_pan, x_lr):
        ...
        return  torch.clamp(restore3+x_lr, -1, 1)
class my_model_3_9(nn.Module):#其实差不多 跟unet
    ...
    def forward(self, x_pan, x_lr):
        ...
        return  torch.clamp(restore3+x_lr, -1, 1)
class my_model_3_6_change(nn.Module):#其实差不多 跟unet
    def __init__(self):
        super(my_model_3_6_change, self).__init__()
        self.encoder1_pan=nn.Sequential(
            nn.Conv2d(in_channels=1,
                      out_channels=32,
                      kernel_size=3,
    ...
    def forward(self, x_pan, x_lr):
        ...
        return  torch.clamp(restore3+x_lr, -1, 1)
class my_model_3_9_2(nn.Module):#其实差不多 跟unet
    def __init__(self):
        super(my_model_3_9_2, self).__init__()
        self.encoder1_pan=nn.Sequential(
            nn.Conv2d(in_channels=1,
                      out_channels=32,
                      kernel_size=3,
